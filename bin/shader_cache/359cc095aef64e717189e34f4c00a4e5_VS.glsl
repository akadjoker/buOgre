...
layout(location = 0) uniform	mat2x4	bone_dualquaternion_array_2x4[38];
layout(location = 76) uniform	mat4	worldviewproj_matrix;
layout(location = 80) uniform	mat3	normal_matrix;
layout(location = 83) uniform	mat4	worldview_matrix;
