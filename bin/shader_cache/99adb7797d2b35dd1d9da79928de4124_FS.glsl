...
layout(location = 3) uniform	vec4	light_position_view_space_array;
layout(location = 4) uniform	vec4	light_direction_view_space_array;
layout(location = 5) uniform	vec4	light_attenuation_array;
layout(location = 6) uniform	vec4	spotlight_params_array;
layout(location = 7) uniform	vec4	derived_light_diffuse_colour_array;
