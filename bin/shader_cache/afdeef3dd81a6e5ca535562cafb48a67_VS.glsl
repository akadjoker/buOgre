...
void main(void) {
	...
	vsTexcoord_3	=	normalize(vsTexcoord_3);
	vsTexcoord_4.xyz	=	mul(normal_matrix, tangent.xyz);
	vsTexcoord_4.xyz	=	normalize(vsTexcoord_4.xyz);
	vsTexcoord_4.w	=	tangent.w;
	lColor_0	=	vec4(1.00000,1.00000,1.00000,1.00000);
	lColor_1	=	vec4(0.00000,0.00000,0.00000,0.00000);
	FFP_Transform(worldview_matrix, vertex, vsTexcoord_5);
